...
import { getIncomeSum } from '../reducer';
            ...
            <div className="calc_block-info">
                <div className="calc_block-profit">
                    ...
                    <div className="calc_block-profit_item">
                        ...
                        {this.chartRef && this.props.investSum !== 0 && (
                            <div
                ...
                <div className="calc_block-profit_rate">
                    Прирост стоимости паев <span className="rate_percents">{this.props.rate.value} %</span>
                </div>
            </div>
        );
    }
